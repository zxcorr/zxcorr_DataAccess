...
def sub_query_string(ang0,ang1,r):
 ...
 sot.zippDetectID, sot.zstackDetectID, sot.zstackImageId, sot.zra, sot.zdec, sot.zraErr, sot.zdecErr, sot.zEpoch, sot.zPSFMag, sot.zPSFMagErr, sot.zApMag, sot.zApMagErr, sot.zKronMag, sot.zKronMagErr,
 sot.yippDetectID, sot.ystackDetectID, sot.ystackImageId, sot.yra, sot.ydec, sot.yraErr, sot.ydecErr, sot.yEpoch, sot.yPSFMag, sot.yPSFMagErr, sot.yApMag, sot.yApMagErr, sot.yKronMag, sot.yKronMagErr, 
 ot.raMean,ot.decMean,ot.raStack,ot.decStack


 from fGetNearbyObjEq("""+",".join([str(ang0),str(ang1),str(r/60.)])+""") nb
 inner join StackObjectThin sot on sot.objid=nb.objid and sot.primaryDetection = 1 
 inner join ObjectThin ot on sot.objid=ot.objid
